...
//    ORB_SLAM3::System SLAM(argv[1], argv[2], ORB_SLAM3::System::GPS_MONOCULAR, true);
    ...
    // Publish fire spots
    auto fire_spots_pub = node->create_publisher<geometry_msgs::msg::PoseArray>
            ("/position/fire_spots", 10);

    // Publish camera pose
    auto camera_pose_pub = node->create_publisher<geometry_msgs::msg::PoseStamped>
